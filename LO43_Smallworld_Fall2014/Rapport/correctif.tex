...
\chapter{Adaptation des règles}
	...
	\begin{description}
		\item[Proche des entreprises : ] Tant que le peuple est pas en déclin, vous gagnez deux UVs supplémentaires à la fin de votre tour.
		...
		\item[Des salles info : ]Prenez une UV supplémentaire pour chaque région avec une salle info à chaque fin de votre tour.
		\item[Des lieux de vie : ]Prenez une UV supplémentaire pour chaque région avec un lieu de vie à chaque fin de votre tour.
		\item[Fayots : ] Choisissez un adversaire que vous n'avez pas attaqué ce tour-ci, il ne pourra pas vous attaqué pendant son tour.
		...
		\item[Ponctuel : ] Les régions amphithéâtre et entreprise nécessitent 1 unité de moins pour être envahie.
